...
import nl.imvdm.hsv.contestapp.repository.TeamRepository;
...
class TeamResourceIT {
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team().naam(DEFAULT_NAAM);
        return team;
    }
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team().naam(UPDATED_NAAM);
        return team;
    }
    ...
    void createTeam() throws Exception {
        ...
        assertThat(testTeam.getNaam()).isEqualTo(DEFAULT_NAAM);
    }
    ...
    void putNewTeam() throws Exception {
        ...
        Team testTeam = teamList.get(teamList.size() - 1);
        assertThat(testTeam.getNaam()).isEqualTo(UPDATED_NAAM);
    }
    ...
    void fullUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.naam(UPDATED_NAAM);
