...
public class PersoonResource {
     ...
     */
    @GetMapping("/persoons")
    public List<Persoon> getAllPersoons(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
    ...
    public ResponseEntity<Persoon> getPersoon(@PathVariable Long id) {
        ...
        Optional<Persoon> persoon = persoonRepository.findOneWithEagerRelationships(id);
