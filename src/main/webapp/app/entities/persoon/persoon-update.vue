    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hsvWedstrijdApp.persoon.vereniging')" for="persoon-vereniging">Vereniging</label>
            <select class="form-control" id="persoon-vereniging" data-cy="vereniging" name="vereniging" v-model="persoon.vereniging">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="persoon.vereniging && verenigingOption.id === persoon.vereniging.id ? persoon.vereniging : verenigingOption"
