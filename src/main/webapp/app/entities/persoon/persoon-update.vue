    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hsvWedstrijdApp.persoon.team')" for="persoon-team">Team</label>
            <select class="form-control" id="persoon-team" data-cy="team" name="team" v-model="persoon.team">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="persoon.team && verenigingOption.id === persoon.team.id ? persoon.team : verenigingOption"
                v-for="verenigingOption in verenigings"
                :key="verenigingOption.id"
              >
                {{ verenigingOption.naam }}
              </option>
            </select>
          </div>
        </div>
