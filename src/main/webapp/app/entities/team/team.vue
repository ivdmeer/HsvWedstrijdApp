      ...
      <table class="table table-striped" aria-describedby="teams">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('hsvWedstrijdApp.team.deelnemer')">Deelnemer</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="team in teams" :key="team.id" data-cy="entityTable">
            ...
            <td>{{ team.naam }}</td>
            <td>
              <div v-if="team.deelnemer">
                <router-link :to="{ name: 'DeelnemerView', params: { deelnemerId: team.deelnemer.id } }">{{
                  team.deelnemer.id
                }}</router-link>
              </div>
            </td>
